 ...
 *
 * Only repo identity now. The pull-request and check shapes lived here too,
 * for a dashboard PR card that no longer exists; they went with it rather than
 * sitting in the barrel as types nothing constructs.
 *
